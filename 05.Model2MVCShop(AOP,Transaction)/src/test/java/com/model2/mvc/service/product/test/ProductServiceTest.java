...
public class ProductServiceTest {
	...
	public void addProduct() throws Exception {
		...
		product.setProdDetail("아버지");
		product.setManuDate("1971-05-26");
		product.setPrice(Integer.parseInt("50000"));
		product.setFileName("");
...
//		user.setEmail("test@test.com");
	...
	//@Test
	 public void updateProduct() throws Exception{
		...
		product.setProdName("김태우");
		product.setProdDetail("사촌 남동생");
		product.setManuDate("2001-06-18");
		product.setPrice(Integer.parseInt("250"));
		product.setFileName("");
